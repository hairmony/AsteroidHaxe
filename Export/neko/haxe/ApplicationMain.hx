...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AsteroidP1", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("AsteroidP1", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.sample.asteroidp1";
